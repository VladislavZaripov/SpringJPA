...
@SqlResultSetMapping(
        name = "singerResult",
        entities = {@EntityResult(entityClass = entity.Singer.class)})

public class Singer implements Serializable {

    public static final String FIND_ALL = "Singer.FIND_ALL";
    public static final String FIND_SINGER_BY_ID = "Singer.FIND_SINGER_BY_ID";
    public static final String FIND_ALL_WITH_ALBUM = "Singer.FIND_ALL_WITH_ALBUM";
